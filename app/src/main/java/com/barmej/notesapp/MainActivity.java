...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       notesItems = NewsListGenerator.generateList(0);
        ...
        mNormalCardViewAdapter = new NormalCardViewAdapter(notesItems, new ItemLongClickListener() {
            @Override
        ...
        checkBoxCardViewAdapter = new CheckBoxCardViewAdapter(notesItems, new ItemLongClickListener() {
            @Override
            public void onLongClickItem(int position) {
                deleteItem(position);
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RECIEVE_NOTES) {
            if (resultCode == RESULT_OK && data != null) {
                ...
                Notes notes = new Notes(Note , photoUri );
